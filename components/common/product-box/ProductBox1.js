    ...
    <div className="product-box product-wrap">
      <div className="img-wrapper">
        <div className="lable-block">
          {product.new === true ? <span className="lable3">Nuevos</span> : ""}
          {product.sale === true ? <span className="lable4">En venta</span> : ""}
        </div>
        ...
        <div className={cartClass}>
          <button title="Añadir al carrito" onClick={addCart}>
                ...
                <Col lg="12">
                  <div className="media">
                    ...
                    <div className="media-body align-self-center text-center">
                      <h5>
                        <i className="fa fa-check"></i>Ítem{" "}
                        <span>{product.title}</span>
                        <span>{" "} agregado exitosamente a su lista de comparación</span>
                      </h5>
          ...
          <ul className="product-thumb-list">
            {product.images.map((img, i) => (
              <li
                ...
                key={i}
              >
                <a href={null} title="Añadir a la lista de deseos">
                  <Media
                    src={`${img.src}`}
                    alt="wishlist"
            ...
            <Col lg="6" className="rtl-text">
              <div className="product-right">
                ...
                <div className="border-product">
                  <h6 className="product-title">Detalles de producto</h6>
