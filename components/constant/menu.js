export const MENUITEMS = [
   {
      title: 'Inicio', type: 'sub', children: [
         {
            title: "Nuevos Productos", type: "sub", tag: 'new', children:
            [
         ...
         {
            title: 'Tendencias', type: 'sub', children: [
         ...
         {
            title: 'Especiales', type: 'sub', children: [
   ...
   {
      title: 'Tienda', type: 'sub', children: [
         { path: '/shop/left_sidebar', title: 'Productos', type: 'link' },
