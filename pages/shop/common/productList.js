...
import Menu2 from "../../../public/assets/images/mega-menu/1.jpg";
                  ...
                  <Col>
                    <div className="product-filter-content">
                      <div className="search-count">
                        <h5>
                          {data
                            ? `Muestra los productos 1-${data.products.items.length} de ${data.products.total}`
                            : "Cargando"}{" "}
                            Resultados
                        </h5>
                      </div>
                      ...
                      <div className="product-page-filter">
                        <select onChange={(e) => setSortBy(e.target.value)}>
                          <option value="AscOrder">Clasificación de elementos</option>
                          <option value="HighToLow">Alto a bajo</option>
                          <option value="LowToHigh">Bajo a alto</option>
                          <option value="Newest">Lo mas nuevo</option>
                          <option value="AscOrder">Orden Asc</option>
                          <option value="DescOrder">Orden Des</option>
                        </select>
                      </div>
                    </div>
                  </Col>
