      ...
      <div className={`product-right ${stickyClass}`}>
        ...
        <div className="product-buttons">
          ...
          <Link href={`/page/account/checkout`}>
            <a className="btn btn-solid">Comprar</a>
          </Link>
        </div>
        <div className="border-product">
          <h6 className="product-title">Detalles del productos</h6>
          <p>{product.description}</p>
        </div>
        <div className="border-product">
          <h6 className="product-title">Comprarte</h6>
          <div className="product-icon">
            <MasterSocial />
          </div>
        </div>
        <div className="border-product">
          <h6 className="product-title">Recordatorio</h6>
          <CountdownComponent />
        </div>
      </div>
    </>
